...
/*
*
* Checks if provided parameters to update a specific XX_Integration for a certain Project are valid or returns an appropiate response.
* @projectId
...
*
*/
module.exports.validUpdateInstanceOfProjectIntegration = function(req, res, next){
  // validate input parameters
  var errors = {};
  var hasErrors = false;
